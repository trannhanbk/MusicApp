...
class ListSongDayViewModel {
    ...
    func cellForRowAtLoveSongDay(at indexPath: IndexPath) -> LisSongDayTableCellViewModel {
        return LisSongDayTableCellViewModel(item: items[indexPath.row])
    }
