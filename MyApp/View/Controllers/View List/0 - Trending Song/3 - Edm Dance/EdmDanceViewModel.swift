...
class EdmDanceViewModel {
    ...
    func cellForRowAtTrendingSongList(at indexPath: IndexPath) -> EDMDanceTableCellViewModel {
        return EDMDanceTableCellViewModel(item: items[indexPath.row])
    }
